...
#create the model with a resolution of 14 days
model_FULL = calliope.Model('../model/euro_calliope/eurospores/model.yaml', scenario='config_overrides,res_3h,link_cap_dynamic,freeze-hydro-capacities,max_energy_caps')
model_FULL.run()
